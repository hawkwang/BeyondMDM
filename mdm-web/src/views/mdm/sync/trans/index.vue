      ...
      <avue-crud ref="crud"
        ...
        <template slot-scope="scope"
          ...
          <el-button type="text"
                     ...
                     size="mini"
                     plain
                     @click="rowStart(scope.row,scope.index)">执行
          </el-button>
          <el-button type="text"
                     icon="el-icon-delete"
                     size="mini"
...
<script>
  import {addObj, startJob, stopJob,fetchList, putObj} from '@/api/mdm/sync/trans'
  import {tableOption} from '@/const/crud/mdm/sync/trans'
